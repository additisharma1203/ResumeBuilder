...
import { ArrowRight, Download, LayoutTemplate,Zap } from 'lucide-react';
    ...
    <div className={landingPageStyles.container}>
      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          ...
          {/* desktop navigation */}
          <div className='hidden_md:flex items-center'>
            {user ? (
              <ProfileInfoCard/>
            ):(
              <button className={landingPageStyles.desktopAuthButton} onClick={()=> setOpenAuthModal(true)}>
                <div className={landingPageStyles.desktopAuthButtonText}></div>
        ...
        <div className={landingPageStyles.heroGrid}>
          ...
          <div className={landingPageStyles.heroLeft}>
            <div className={landingPageStyles.tagline}>
              Good Resume,Good Future
            </div>

            <h1 className={landingPageStyles.heading}>
              <span className={landingPageStyles.headingGradient}>Build Your Resume</span>
            </h1>

            <p className={landingPageStyles.description}>
              Enhance your future by building best Professional Resumes.
              ATS-friendly and design as per your goals.
            </p>
            ...
            <div className={landingPageStyles.statsContainer}>
              {[
                { value: '50+', label: 'Resumes Created', gradient: 'from-violet-600 to-fuchsia-600' },
        ...
        <div className={landingPageStyles.featuresContainer}>
          <div className={landingPageStyles.featuresHeader}>
            <h2 className={landingPageStyles.featuresTitle}>
              Reason to trust us <span className={landingPageStyles.featuresTitleGradient}>ResumeChecker?</span>
            </h2>
            <p className={landingPageStyles.featureDescription}>
              Everything you need to create a professional resume that stands out in crowd
            </p>
          </div>
          ...
          <div className={landingPageStyles.ctaCard}>
            ...
            <div className={landingPageStyles.ctaCardContent}>
              ...
              <p className={landingPageStyles.ctaDescription}>
                Join number of professional who landed their dream jobs with our platform
              </p>
              <button className={landingPageStyles.ctaButton} onClick={handleCTA}>
                <div className={landingPageStyles.ctaButtonOverlay}></div>
                <span className={landingPageStyles.ctaButtonText}>Start Creating</span>
              </button>
            </div>
          </div>
        </div>
     ...
     <footer className={landingPageStyles.footer}>
      <div className={landingPageStyles.footerContainer}>
        <p className={landingPageStyles.footerText}>
          Crafted  <span className={landingPageStyles.footerHeart}>❤️</span> by{' '}Love
        </p>
      </div>
     </footer>
